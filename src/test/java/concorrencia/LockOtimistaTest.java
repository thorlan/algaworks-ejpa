...
public class LockOtimistaTest {
    ...
    public void usarLockOtimista() {
    	...
    	//USAR @VERSION EM ALGUM INTEGER NAS ENTIDADES QUE QUERO TRAVAR
    	//O LOCKOTIMISTA NAO TRAVA A SITUACAO, LARGA O OPTMISTLOCKEXCEPTION E CONTINUA A VIDA
    	//CALENDAR, LOCALDATIME, DATE, POSSO USAR O @VERSION COM QUALQUER ITEM DESSES!
