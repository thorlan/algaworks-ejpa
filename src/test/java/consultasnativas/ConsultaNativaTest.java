...
public class ConsultaNativaTest extends EntityManagerTest {
	...
	public void usarColumnResultRetornarDTO() {
		...
		Query query = em.createNativeQuery(sql, "ecm_produto.ProdutoDTO");
	...
	public void usarFieldResult() {
		...
		Query query = em.createNativeQuery(sql, "ecm_produto.Produto");
	...
	public void usarSQLResultSetMapping02() {
		...
		Query query = em.createNativeQuery(sql, "item_pedido-produto.ItemPedido-Produto");
...
//                " from ecm_produto";
		...
		String sql = "select id, nome, descricao, " + "            null data_criacao, null data_ultima_atualizacao, "
				+ "            preco, null foto, produto null " + " from erp_produto";
